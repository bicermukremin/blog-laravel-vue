    ...
    <div role="main" class="main">
      ...
      <div class="container">
        <div class="row pt-4 mb-4">
          <div class="col-lg-7">
            <h2 class="mb-0">Bize Yaz!</h2>

            <p class="lead mb-4 mt-1">
              Mesaj atarak ya da telefonla bize ulaşın, size yardımcı olalım!
            </p>

            <Contact></Contact>
          </div>
          <div class="col-lg-4 col-lg-offset-1">
            <h4 class="text-color-dark mb-1 pb-3">Aradığınız Yer</h4>
            ...
            <ul class="list list-icons mt-4 mb-4">
              <li>
                <i class="icon-pin icons"></i> <strong>Adres:</strong>
                {{ getSetting.adres }}
              </li>
              <li>
                <i class="icon-call-end icons"></i> <strong>Telefon:</strong>
                {{ getSetting.tel }}
              </li>
              <li>
                <i class="icon-envelope icons"></i> <strong>Mail:</strong>
                <a href="mailto:getSetting.map">{{ getSetting.email }}</a>
              </li>
            </ul>
          </div>
        </div>
