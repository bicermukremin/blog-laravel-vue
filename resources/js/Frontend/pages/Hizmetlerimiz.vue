        ...
        <div class="row pt-2">
          <div class="col-lg-3">
            <aside class="sidebar">
              ...
              <h4 class="pt-4 mb-3 text-color-dark">Bize Yaz</h4>
          ...
          <div class="col-lg-9">
            <div class="row mt-4" v-for="service in getServices" :key="service.id">
              <div class="col">
                <div
                  class="feature-box feature-box-style-2 align-items-start mb-4 ml-lg-5 appear-animation"
