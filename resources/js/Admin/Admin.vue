<template>
        ...
        <li :class="{ show: Active1 }">
          <a
            href="#"
            class="dropdown-toggle notification-icon"
            data-toggle="dropdown"
            @click.prevent="showLink1"
          >
            <i class="bx bx-list-ol"></i>
            <span class="badge">3</span>
          </a>

          <div class="dropdown-menu notification-menu large" :class="{ show: Active1 }">
        ...
        <li :class="{ show: Active2 }">
          <a
            href="#"
            class="dropdown-toggle notification-icon"
            data-toggle="dropdown"
            @click.prevent="showLink2"
          >
            <i class="bx bx-envelope"></i>
            <span class="badge">4</span>
          </a>

          <div class="dropdown-menu notification-menu" :class="{ show: Active2 }">
            <div class="notification-title">
                ...
                <li>
                  <a href="#" class="clearfix">
                    ...
                    <span class="message truncate"
                      ...
                      risus non luctus. Nunc cursus lacinia lacinia. Nulla molestie
                      malesuada est ac tincidunt. Quisque eget convallis diam, nec
                      ...
                      rutrum eros ut, convallis nisi. Sed tellus turpis, dignissim sit
                      amet tristique quis, pretium id est. Sed aliquam diam diam, sit amet
                      faucibus tellus ultricies eu. Aliquam lacinia nibh a metus bibendum,
                      eu commodo eros commodo. Sed commodo molestie elit, a molestie lacus
                      porttitor id. Donec facilisis varius sapien, ac fringilla velit
                      porttitor et. Nam tincidunt gravida dui, sed pharetra odio pharetra
                      nec. Duis consectetur venenatis pharetra. Vestibulum egestas nisi
                ...
                <li>
                  <a href="#" class="clearfix">
                    ...
                    <span class="message"
                      ...
                      amet lacinia orci. Proin vestibulum eget risus non luctus. Nunc
                      cursus lacinia lacinia. Nulla molestie malesuada est ac tincidunt.
                      Quisque eget convallis diam.</span
                    >
                  </a>
                </li>
              </ul>
        ...
        <li :class="{ show: Active3 }">
          <a
            href="#"
            class="dropdown-toggle notification-icon"
            data-toggle="dropdown"
            @click.prevent="showLink3"
          >
            <i class="bx bx-bell"></i>
            <span class="badge">3</span>
          </a>

          <div class="dropdown-menu notification-menu" :class="{ show: Active3 }">
            <div class="notification-title">
              <span class="float-right badge badge-default">3</span>
              Alerts
            </div>
							...
							<ul class="nav nav-main">
								...
								<li class="nav-parent">
									...
									<ul class="nav nav-children">
										...
										<li class="nav-parent">
											<a class="nav-link" href="#">
												Icons <span class="mega-sub-nav-toggle toggled float-right"
										...
										<li class="nav-parent">
											<a class="nav-link" href="#">
												Animations <span class="mega-sub-nav-toggle toggled float-right"
													data-toggle="collapse"
										...
										<li class="nav-parent">
											<a class="nav-link" href="#">
												Loading <span class="mega-sub-nav-toggle toggled float-right"
													data-toggle="collapse"
