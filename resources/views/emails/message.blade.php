            ...
            <section id="history" class="mb-4">
              ...
              <div class="row" style="background-color: #E04622;">
                <div class="col-lg-7">
                  ...
                  <p class="mt-4" >
                    Sayın <strong>{{$input['ad_soyad']}}</strong>
                  </p>
                  <p class="mt-4">
                    Göndermiş olduğunuz "{{$input['konu']}}" konulu mesajınız tarafımıza ulaşmıştır. En kısa sürede size dönüş yapılacaktır. İlginiz için teşekkürler.
                  </p>
                </div>
